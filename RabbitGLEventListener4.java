...
public class RabbitGLEventListener4 extends RabbitListener implements GLEventListener, MouseListener {
    int score=0;
    ...
    long timertime;
    String textureNames[] = {"Rabbit.png", "Hammer.png", "Hole.png", "Boom.png", "Hit.png", "Back.png", "hammer3.png"};
    TextureReader.Texture texture[] = new TextureReader.Texture[textureNames.length];
    int textures[] = new int[textureNames.length];
///////////////////////////////////////////////////
    int timer = 1800;
//////////////////////////////////////////////////
    public RabbitGLEventListener4() {
...
//////////////////////////////////////////////////
    ...
    public void display(GLAutoDrawable glAutoDrawable) {
        ...
        DrawRabbit(gl);
        DrawHammer(gl);
        if (xclicked >= xpos - 5 && xclicked <= xpos + 15) {
            if (yclicked >= ypos - 5 && yclicked <= ypos + 15) {
                DrawBackground(gl);
...
//        handleKeyPress();
    ...
    public void DrawHammer(GL gl) {
        if (mouseClick) {
            DrawSprite(gl, xmove - 5, ymove - 5, 6, 1f);
        } else {
