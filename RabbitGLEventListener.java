...
public class RabbitGLEventListener extends RabbitListener {
        ...
        boolean sound, changeState, levels, back, easy = false , meduim = false , hard= false , puase =false;
      ...
      private final TextRenderer textRenderer = new TextRenderer(new Font("SansSerif", Font.PLAIN, 24));
        String textureNames[] = {"Rabbit.png", "Hammer.png", "Hole.png", "Boom.png", "Hit.png", "Back.png",
                ...
                "backbtn.png", "hammmmer3.png","HowToPlay.png","puase.png","back1.jpg"};
...
//        handleKeyPress();
    ...
    void Drawpuase(GL gl, int x, int y) {
        DrawSprite2(gl, x - 8, y - 8, 16, 0.85f, 0.85f);
        ...
        else  if(mouseX >= 88 && mouseX <= 95 && mouseY <= 96 && mouseY >= 90  && levels ) {
            puase = true;
