...
//        boolean sound, changeState, levels, back, easy, medium, hard,exit, howToPlay = false;
...
//                   changeLevels(gl, v);
//               }
//              else if(medium && levels) {
//                   changeLevels(gl, v - 500);
//               }
//
//        //start menu
...
//
//    }
//        public void GenerateRabbit (int v) {
...
//
//        }
//        else  if(mouseX >= 38 && mouseX <= 60 && mouseY <= 57 && mouseY >= 46 && levels == false ) {
//            howToPlay = true;
//          //  back=false;
//
//        }
//        else  if(mouseX >= 38 && mouseX <= 60 && mouseY <= 58 && mouseY >= 44 && levels ) {
//            medium = true;
//
//        }
//        else  if(mouseX >= 38 && mouseX <= 60 && mouseY <= 36 && mouseY >= 26 && levels == false ) {
//            exit = true;
//        }
//
//    }
...
public class RabbitGLEventListener extends RabbitListener {
    ...
    int lives = 4;
    int x = maxWidth / 2, y = maxHeight / 2;
    boolean sound, changeState, levels, back, easy, howToPlay, home, playAgain, gameOver = false ,  puase=false , restart=false;
    int x2 = 0, y2 = 0;
    int[][] HoleIndex = new int[3][3];
    ...
    String textureNames[] = {"Rabbit.png", "Hammer.png", "Hole.png", "Boom.png", "Hit.png", "Back.png",
            ...
            "restart.png", "resume.png", "back1.jpg", "Hamme2r.png", "Hamer3.png", "Hammer4.png", "gameOver.png", "puase.png"};
    TextureReader.Texture texture[] = new TextureReader.Texture[textureNames.length];
    int textures[] = new int[textureNames.length];
...
//reversing direction of y axis
        ...
        if (gameStarted && !(xclicked >= xpos - 5 && xclicked <= xpos + 10 &&
                yclicked >= ypos - 10 && yclicked <= ypos + 16)) {
            lives--;
        }
    ...
    void Drawpuase(GL gl, int x, int y) {
        DrawSprite2(gl, x - 8, y - 8, 25, 0.85f, 0.85f);
